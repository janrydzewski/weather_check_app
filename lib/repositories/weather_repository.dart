...
class WeatherRepository {
  ...
  Future<WeatherModel> getWeather(String city) async {
    ...
    final weatherResponse = await dio.get(
        "https://api.open-meteo.com/v1/forecast?latitude=${cityModel?.latitude}&longitude=${cityModel?.longitude}&hourly=temperature_2m,precipitation_probability,weathercode,pressure_msl,visibility,windspeed_10m&timezone=auto&forecast_days=2");
